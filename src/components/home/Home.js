...
const Home = () => {
  return (
    <div className='home-content'>
      <div className='profile-pic'><img src={require('./profile-pic.jpg')} alt-text="Profile picture"></img></div>
        <div className='home-left-col'>
          ...
          <div className='home-icons-container'>
            ...
            <span><Link to ='/contact'><span className="home-icons"><i class="fas fa-envelope"></i></span></Link></span>
          </div>
        </div>
    </div>
  )
